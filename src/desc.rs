//! Documents de description UPnP : périphérique racine et SCPD des services.

use crate::soap::escape_xml;
use crate::AppState;

pub fn device_description(st: &AppState) -> String {
    format!(
...
<manufacturer>server_upnp</manufacturer>
<modelDescription>Serveur UPnP/DLNA minimal sans indexation</modelDescription>
<modelName>server_upnp</modelName>
...
<eventSubURL>/cm/event</eventSubURL>
        ...
        name = escape_xml(&st.friendly_name),
        uuid = st.uuid
    )
}

pub const CD_SCPD: &str = r#"<?xml version="1.0" encoding="utf-8"?>
...
pub const CM_SCPD: &str = r#"<?xml version="1.0" encoding="utf-8"?>
<scpd xmlns="urn:schemas-upnp-org:service-1-0">
<specVersion><major>1</major><minor>0</minor></specVersion>
<actionList>
<action>
